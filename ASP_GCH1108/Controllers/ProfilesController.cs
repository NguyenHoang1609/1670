...
namespace ASP_GCH1108.Controllers
{
    public class ProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProfileId,Name,PhoneNumber,Address,BirthDay,Height,Weight,UserId")] Profile profile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProfileId,Name,PhoneNumber,Address,BirthDay,Height,Weight,UserId")] Profile profile)
        {
